  ...
  <section id="projects" className="scroll-mt-24 overflow-hidden">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {resumeData.projects.map((project, idx) => (
        <div
          key={idx}
          className="relative group corner-brackets animate-child-reveal"
          style={{ animationDelay: `${0.15 + idx * 0.1}s` }}
        >
          <div
            className="border border-neutral-800/80 rounded-sm overflow-hidden bg-black/40 hover:border-neutral-600 transition-all duration-200 flex flex-col shadow-[0_0_15px_rgba(0,0,0,0.5)] h-full"
          >
            {/* Header */}
