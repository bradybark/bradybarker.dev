...
const SIDE_NAV_ITEMS = [
    ...
    { id: 'projects', label: 'Key Projects', icon: Icons.GemIcon },
    { id: 'skills', label: 'Skills', icon: Icons.CpuIcon },
    { id: 'education', label: 'Education', icon: Icons.GraduationCapIcon },
    { id: 'bio', label: 'About Me', icon: Icons.UserIcon },
];
